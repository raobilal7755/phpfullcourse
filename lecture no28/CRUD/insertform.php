...
<body class="bg-info">
	<h1 class="bg-danger text-center text-white p-4">INSERT DATA INTO DATABASE</h1>
	
	<div class="container">
		<div class="alert alert-danger" >
		<a href="./main_view_file.php" class="btn btn-success btn-lg"> Student List</a>
	</div>
		<form method="post" action="action.php">
			...
			<br>
			<input type="submit" name="btn" value="Submit Form" class="btn btn-danger btn-lg">
		</form>
	</div>
</body>
</html>